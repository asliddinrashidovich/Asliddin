...
function Hero() {
  ...
  return (
    <section
      className="pt-[170px] pb-[100px] min-h-[100vh] bg-[#fff] px-5 md:px-10"
      id="hero"
    >
      ...
      <div className="max-w-[1200px] mx-auto relative z-[99]  grid lg:grid-cols-2 lg:flex items-center ">
        <div className="max-w-[650px]">
          <h2 className="font-medium lg:font-[700] flex gap-[10px] items-center text-[#999] text-3xl lg:text-4xl">
          ...
          <div className="flex gap-5 asliddin mb-5">
            ...
            >
              <Link
                className="hero_icon"
                target="_blank"
                href="https://t.me/asliddin_it_blog"
              >
            ...
            >
              <Link
                className="hero_icon"
                target="_blank"
                href="https://www.youtube.com/@AsliddinNorboyev_blog"
              >
            ...
            >
              <Link
                className="hero_icon"
                target="_blank"
                href="https://www.linkedin.com/in/asliddinnorboyev"
              >
