  ...
  return (
    <section id="about" className="bg-[#212429] py-10 lg:py-20 relative">
      <div className="max-w-[1200px] mx-auto px-8">
        <h2 className="text-center text-3xl lg:text-5xl font-semibold text-white mb-3">
          About Me
        </h2>
        ...
        <div className="block lg:flex justify-between gap-[50px]">
          <div className="max-w-[800px] mx-auto lg:mx-0 mb-10 lg:mb-0">
            <h3 className="text-white text-center lg:text-start text-2xl lg:text-4xl font-medium lg:font-semibold mb-5">
              I am
              <span className="text-[#21c998]">
                {" "}
